...
private final class IOFiber[A](
  ...
  override def run(): Unit = {
    ...
    (resumeTag: @switch) match {
      ...
      case 4 => afterBlockingSuccessfulR(conts, objectState)
      case 5 => afterBlockingFailedR(conts, objectState)
      case 6 => evalOnR(conts, objectState)
      case 7 => cedeR(conts, objectState)
      case 8 => autoCedeR(conts, objectState)
      case 9 => ()
    }
  }
    ...
    if (shouldFinalize()) {
      ...
      (cur0.tag: @switch) match {
        case 0 =>
          ...
          runLoop(
            succeeded(cur.value, 0, conts, objectState),
            nextCancelation,
            nextAutoCede,
            conts,
            objectState)
        ...
        case 1 =>
          ...
          runLoop(
            failed(cur.t, 0, conts, objectState),
            nextCancelation,
            nextAutoCede,
            conts,
            objectState)
        ...
        case 2 =>
          ...
          val next =
            if (error == null) succeeded(r, 0, conts, objectState)
            else failed(error, 0, conts, objectState)

          runLoop(next, nextCancelation, nextAutoCede, conts, objectState)

        /* RealTime */
        case 3 =>
          runLoop(
            succeeded(runtime.scheduler.nowMillis().millis, 0, conts, objectState),
            nextCancelation,
            nextAutoCede,
            conts,
            objectState)
        ...
        case 4 =>
          runLoop(
            succeeded(runtime.scheduler.monotonicNanos().nanos, 0, conts, objectState),
            nextCancelation,
            nextAutoCede,
            conts,
            objectState)
        ...
        case 5 =>
          runLoop(
            succeeded(currentCtx, 0, conts, objectState),
            nextCancelation,
            nextAutoCede,
            conts,
            objectState)
        ...
        case 6 =>
          ...
          def next(v: Any): IO[Any] = {
            ...
            if (error == null) succeeded(result, 0, conts, objectState)
            else failed(error, 0, conts, objectState)
          }
          ...
          (ioe.tag: @switch) match {
            case 0 =>
              ...
              runLoop(next(pure.value), nextCancelation - 1, nextAutoCede, conts, objectState)

            case 1 =>
              val error = ioe.asInstanceOf[Error]
              runLoop(
                failed(error.t, 0, conts, objectState),
                nextCancelation - 1,
                nextAutoCede,
                conts,
                objectState)
            ...
            case 2 =>
              ...
              runLoop(nextIO, nextCancelation - 1, nextAutoCede, conts, objectState)

            case 3 =>
              val realTime = runtime.scheduler.nowMillis().millis
              runLoop(next(realTime), nextCancelation - 1, nextAutoCede, conts, objectState)

            case 4 =>
              val monotonic = runtime.scheduler.monotonicNanos().nanos
              runLoop(next(monotonic), nextCancelation - 1, nextAutoCede, conts, objectState)

            case 5 =>
              val ec = currentCtx
              runLoop(next(ec), nextCancelation - 1, nextAutoCede, conts, objectState)

            case _ =>
              objectState.push(f)
              conts.push(MapK)
              runLoop(ioe, nextCancelation, nextAutoCede, conts, objectState)
          }
        ...
        case 7 =>
          ...
          (ioe.tag: @switch) match {
            ...
            case 2 =>
              ...
              runLoop(result, nextCancelation - 1, nextAutoCede, conts, objectState)
        ...
        case 8 =>
          ...
          (ioa.tag: @switch) match {
            case 0 =>
              ...
              runLoop(
                succeeded(Right(pure.value), 0, conts, objectState),
                nextCancelation - 1,
                nextAutoCede,
                conts,
                objectState)
            ...
            case 1 =>
              ...
              runLoop(
                succeeded(Left(error.t), 0, conts, objectState),
                nextCancelation - 1,
                nextAutoCede,
                conts,
                objectState)
            ...
            case 2 =>
              ...
              val next =
                if (error == null) succeeded(Right(result), 0, conts, objectState)
                else succeeded(Left(error), 0, conts, objectState)
              runLoop(next, nextCancelation - 1, nextAutoCede, conts, objectState)

            case 3 =>
              val realTime = runtime.scheduler.nowMillis().millis
              runLoop(
                succeeded(Right(realTime), 0, conts, objectState),
                nextCancelation - 1,
                nextAutoCede,
                conts,
                objectState)
            ...
            case 4 =>
              val monotonic = runtime.scheduler.monotonicNanos().nanos
              runLoop(
                succeeded(Right(monotonic), 0, conts, objectState),
                nextCancelation - 1,
                nextAutoCede,
                conts,
                objectState)
            ...
            case 5 =>
              val ec = currentCtx
              runLoop(
                succeeded(Right(ec), 0, conts, objectState),
                nextCancelation - 1,
                nextAutoCede,
                conts,
                objectState)
            ...
            case _ =>
              conts.push(AttemptK)
              runLoop(ioa, nextCancelation, nextAutoCede, conts, objectState)
          }
        ...
        case 9 =>
          ...
          runLoop(cur.ioa, nextCancelation, nextAutoCede, conts, objectState)
        ...
        case 12 =>
          ...
          runLoop(cur.body(poll), nextCancelation, nextAutoCede, conts, objectState)
          ...
          if (state.compareAndSet(ContStateInitial, ContStateWaiting)) {
            ...
            if (!shouldFinalize()) {
              ...
              val next = result match {
                case Left(t) => failed(t, 0, conts, objectState)
                case Right(a) => succeeded(a, 0, conts, objectState)
              }
        ...
        case 17 =>
          ...
          runLoop(
            succeeded(fiber, 0, conts, objectState),
            nextCancelation,
            nextAutoCede,
            conts,
            objectState)
        ...
        case 22 =>
          ...
          runLoop(
            succeeded(value, 0, conts, objectState),
            nextCancelation,
            nextAutoCede,
            conts,
            objectState)
  ...
  private[this] def succeeded(
    ...
    (conts.pop(): @switch) match {
      ...
      case 5 =>
        ...
        objectState.pop()
        succeeded(result, depth, conts, objectState)
      case 6 => onCancelSuccessK(result, depth, conts, objectState)
      case 7 => uncancelableSuccessK(result, depth, conts, objectState)
      case 8 => unmaskSuccessK(result, depth, conts, objectState)
      case 9 => succeeded(Right(result), depth, conts, objectState)
    }
  ...
  private[this] def failed(
    ...
    (k: @switch) match {
      ...
      case 8 => unmaskFailureK(error, depth, conts, objectState)
      case 9 => succeeded(Left(error), depth, conts, objectState) // attemptK
    }
  }
  ...
  private[this] def execR(conts: ByteStack, objectState: ArrayStack[AnyRef]): Unit = {
    ...
    if (canceled) {
      ...
      val io = resumeIO
      resumeIO = null
      runLoop(io, cancelationCheckThreshold, autoYieldThreshold, conts, objectState)
    }
  }
  ...
  private[this] def asyncContinueSuccessfulR(
    ...
    runLoop(
      succeeded(a, 0, conts, objectState),
      cancelationCheckThreshold,
      autoYieldThreshold,
      conts,
      objectState)
  ...
  private[this] def afterBlockingSuccessfulR(
    ...
    runLoop(
      succeeded(result, 0, conts, objectState),
      cancelationCheckThreshold,
      autoYieldThreshold,
      conts,
      objectState)
  ...
  private[this] def afterBlockingFailedR(
    ...
    runLoop(
      failed(error, 0, conts, objectState),
      cancelationCheckThreshold,
      autoYieldThreshold,
      conts,
      objectState)
  ...
  private[this] def evalOnR(conts: ByteStack, objectState: ArrayStack[AnyRef]): Unit = {
    val ioa = resumeIO
    resumeIO = null
    runLoop(ioa, cancelationCheckThreshold, autoYieldThreshold, conts, objectState)
  }

  private[this] def cedeR(conts: ByteStack, objectState: ArrayStack[AnyRef]): Unit = {
    runLoop(
      succeeded((), 0, conts, objectState),
      cancelationCheckThreshold,
      autoYieldThreshold,
  ...
  private[this] def autoCedeR(conts: ByteStack, objectState: ArrayStack[AnyRef]): Unit = {
    val io = resumeIO
    resumeIO = null
    runLoop(io, cancelationCheckThreshold, autoYieldThreshold, conts, objectState)
  }
  ...
  private[this] def mapK(
    ...
    if (depth > MaxStackDepth) {
      ...
      if (error == null) succeeded(transformed, depth + 1, conts, objectState)
      else failed(error, depth + 1, conts, objectState)
    }
  }
  ...
  private[this] def flatMapK(
    ...
    try f(result)
      ...
      case NonFatal(t) =>
        failed(t, depth + 1, conts, objectState)
      case t: Throwable =>
        onFatalFailure(t)
    }
  }
  ...
  private[this] def onCancelSuccessK(
      ...
      objectState: ArrayStack[AnyRef]): IO[Any] = {
    finalizers.pop()
    succeeded(result, depth + 1, conts, objectState)
  }
